...
function ControlCenter() {
        return (
            <div style={{padding:40}}>
                <div style={{display:"flex", flexDirection :'row'}}><img src={whatsNewIcon} title="What's New" alt="What's New"></img><Title  style={styles.helpHeadingTitle} >What's New in Control Center</Title></div>
