...
class NonQualifiedEmail extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dateRange: 2,
            ...
            <Form style={{ marginLeft: "5%" }}>
              <Form.Item>
                <Row style={{ display: "flex", marginTop: "2%", marginLeft: "5%" }}>
                  <p style={{ width: "10%", marginRight: "2%" }}>Sender:</p>
              ...
              <Form.Item>
                <Row style={{ display: "flex", marginTop: "", marginLeft: "5%" }}>
                  <p style={{ width: "10%", marginRight: "2%" }}>Recipient:</p>
                  <Input style={{ width: "40%" }}
                    value={this.state.inputVal}
                    onChange={this.handleInputChange}
                  ></Input></Row>
              ...
              <Form.Item>
                <Row style={{ display: "flex", marginTop: "", marginLeft: "5%" }}>
                  <p style={{ width: "10%", marginRight: "2%" }}>Subject:</p>
                  <Input style={{ width: "40%" }}
                    value={this.state.inputVal}
                    onChange={this.handleInputChange}
                  ></Input></Row>
              ...
              <Form.Item>
                ...
                <Row style={{ display: "flex", marginLeft: "5%"}} >

                  {/* <div style={{ marginLeft: "50px", display: "flex", width: "33%" }}> */}
                  <p style={{ width: "10%", marginRight: "2%" }}>Sent Between:</p>
                    <Select
                      placeholder={formatMessage(messages["DD"])}
                      style={{ width: "90px", height: 40, marginRight: "0.7%" }}
              ...
              <Form.Item>
                ...
                <Row style={{ display: "flex", marginLeft: "5%"}} >
                  ...
                  {/* <div style={{ marginLeft: "50px", display: "flex", width: "33%" }}> */}
                  <p style={{ width: "10%", marginRight: "2%" }}>Received Between:</p>
                    <Select
                      placeholder={formatMessage(messages["DD"])}
                      style={{ width: "90px", height: 40, marginRight: "0.7%" }}
                      onChange={e => this.handleChangeFromDay(e)}
              ...
              <Form.Item>
                ...
                <Row style={{ display: "flex", marginLeft: "5%"}} >
                  ...
                  {/* <div style={{ marginLeft: "50px", display: "flex", width: "33%" }}> */}
                  <p style={{ width: "10%", marginRight: "2%" }}>Audited Between:</p>
                    <Select
                      placeholder={formatMessage(messages["DD"])}
                      style={{ width: "90px", height: 40, marginRight: "0.7%" }}
                      onChange={e => this.handleChangeFromDay(e)}
...
export default NonQualifiedEmail;
