...
class ArchivalEmail extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dateRange: 2,
      ...
      <div style={{ marginTop: "10%" }}>
        <Collapse bordered={false} defaultActiveKey={['1']} >
          <Panel header="Search Criteria" key="1" style={{ marginLeft: "10%", color: `${color.Blue}`, fontSize: "20px", border: 0 }} >
            <Form style={{ marginLeft: "5%", marginTop: "3%" }}>
              <Form.Item>
                <Radio.Group onChange={this.onChangeRadio} value={this.state.value} style={{ width: "100%" }}>
                  ...
                  <Row style={{ display: "flex" }}>
                    <Radio style={radioStyle} value={2}>
                      By Month:</Radio>
                    <div style={{ marginLeft: "38px", display: "flex", width: "20%" }}>
                      <Select
                        placeholder={formatMessage(messages["MM"])}
                        style={{ width: "110px", height: 40, marginRight: "5%" }}
                        onChange={e => this.handleChangeFromMonth2(e)}
                        onFocus={this.onFocus}
                        onBlur={this.onBlur}
                        onSearch={this.onSearch}
                        value={this.state.monthFromRange2}
                    ...
                    <Select
                      placeholder={formatMessage(messages["MM"])}
                      style={{ width: "90px", height: 40, marginRight: "1%" }}
                      onChange={e => this.handleChangeToMonth2(e)}
                      onFocus={this.onFocus}
                      onBlur={this.onBlur}
                      onSearch={this.onSearch}
                      value={this.state.monthToRange2}
                      disabled={this.state.disableMonth}
                    >
                      {startMonth}
                    </Select>
