...
const messages = defineMessages({
    'Deleted Your Saved Email': {
        id: "ReleasesLegalHold.DeletedYourSavedEmail",
        defaultMessage: "Deleted Your Saved Email",
    },
    'Release Legal Hold': {
        id: "ReleasesLegalHold.ReleaseLegalHold",
        defaultMessage: "Release Legal Hold"
    },
    'Are you sure you want to release the following Legal Hold(s)?': {
        id: "ReleasesLegalHold.AreyousureyouwanttoreleasethefollowingLegalHold(s)",
        defaultMessage: "Are you sure you want to release the selected Legal Hold(s)?"
    },
    'Name:': {
        id: "ReleasesLegalHold.Name",
        defaultMessage: "Name:"
    },
    'Description:': {
        id: "ReleasesLegalHold.Description",
        defaultMessage: "Description:"
    },
    'Submit': {
        id: "ReleasesLegalHold.Submit",
        defaultMessage: "Submit"
    },
    'Cancel': {
        id: "ReleasesLegalHold.Cancel",
        defaultMessage: "Cancel"
    },
    'Releases Legal Hold': {
        id: "ReleasesLegalHold.ReleasesLegalHolds",
...
class ReleasesLegalHold extends Component {
    ...
    render() {
        const { legalHoldReleases, formatMessage, selectedDocs } = this.props
        return (
            <Drawer
                style={{ marginTop: 125 }}
            ...
            >
                <div style={{ ...style.setting.drawerMain }}>
                    <div style={{ ...style.setting.drawerIconTitleWrapper }}>
                        ...
                        <Title style={{ color: `${color.Blue}`, padding: "15px 0 0 5px", fontSize: 24 }}>{formatMessage(messages["Release Legal Hold"])}</Title>
                    </div>
                ...
                <div>
                    <div style={{ marginBottom: 20 }}>
                        <p style={{ margin: 0, padding: 0 }}>{formatMessage(messages["Are you sure you want to release the following Legal Hold(s)?"])}</p>
                    </div>
                    ...
                    <div style={{ ...style.drawerButtons }}>
                        <PrimaryButton text={formatMessage(messages["Submit"])} onClick={() => selectedDocs.length && this.props.releaseLegalHolds()} />
